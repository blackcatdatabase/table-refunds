...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'payment_id', 'amount', 'currency', 'reason', 'status', 'created_at', 'details' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'payment_id' ]; }
