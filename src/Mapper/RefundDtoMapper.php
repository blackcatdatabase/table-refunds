...
namespace BlackCat\Database\Packages\Refunds\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO RefundDto:
...
final class RefundDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'payment_id' ];
    /** @var string[] */
     ...
     * @return RefundDto
     */
    public static function fromRow(array $row): RefundDto
    {
        /** @var RefundDto */
    ...
    public static function fromRowOrNull(?array $row): ?RefundDto
    {
     ...
     */
    public static function toRow(RefundDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RefundDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RefundDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RefundDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RefundDto>
     */
