...
final class RefundsModule implements ModuleInterface
{
    public function name(): string { return 'table-refunds'; }
    public function table(): string { return 'refunds'; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_refunds_payment', 'fk_refunds_tenant' ];
