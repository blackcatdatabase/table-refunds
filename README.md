...
> Schema package for table **refunds** (repo: `refunds`).
...
## Relationships
- FK → **payments** via (tenant_id,payment_id) (ON DELETE CASCADE).
...
erDiagram
  ...
  REFUNDS }o--|| PAYMENTS : "tenant_id, payment_id"
  REFUNDS }o--|| TENANTS : "tenant_id"
```
