...
| Pkg folder | [packages/refunds](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/refunds) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package refunds -Apply
