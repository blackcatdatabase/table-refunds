...
- Pkg folder: [packages\refunds](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\refunds)
...
graph LR
  ...
  refunds["refunds"]:::center
  refunds -->|FK| payments["payments"]:::link
  refunds -->|FK| tenants["tenants"]:::accent
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package refunds -Apply
